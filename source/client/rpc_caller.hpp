...
namespace rpc
{
    namespace client
    {
        ...
        public:
            ...
            using JsonRequestCallback = std::function<void(const Json::Value &)>;
            ...
            bool call(const BaseConnection::ptr &conn, const std::string &method, const Json::Value &params, const JsonRequestCallback &cb)
            {
                auto req_msg = MessageFactory::create<RpcRequest>();
                req_msg->setId(UUID::uuid());
                req_msg->setMethod(method);
        ...
        private:
            void Callback1(const JsonRequestCallback &cb, const BaseMessage::ptr &msg)
            {
